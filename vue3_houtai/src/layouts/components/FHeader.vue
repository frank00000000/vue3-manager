 ...
 * @LastEditTime: 2023-07-19 01:24:28
 * @FilePath: \vue3_houtai\src\layouts\components\FHeader.vue
    ...
    <div class="ml-auto flex items-center ">
      ...
      <el-dropdown class="dropdown" @command="handleComment">
        <span class="flex items-center justify-between text-light-50">
          <el-avatar :size="25" :src="$store.state.user.avatar" fil="cover" />
          <span class="mx-3">
...
<style scoped>
  .f-header{
      @apply flex items-center bg-indigo-500 h-[64px] fixed top-0 left-0 right-0 z-100
  }
